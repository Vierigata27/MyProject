...
$barang = mysqli_query($koneksi, "SELECT * FROM susu WHERE id_barang = $id_barang")->fetch_assoc();

if (isset($_POST["submit"])) {
    if (ubah2($_POST) > 0) {
        echo "<script>
            alert('Data berhasil diupdate!');
            document.location.href = 'susu.php';
        </script>";
    } else {
        echo "<script>
