...
if (isset($_POST["submit"])) {
    $produk = tampil("SELECT * FROM telur ORDER BY harga_barang DESC");
} else {
    $produk = tampil("SELECT * FROM telur"); // Default sorting
}
?>
...
<head>
    ...
    <title>PERBANDINGAN HARGA TELUR</title>
   <style>
.tombol {
  display: flex;
...
<body>
  <div class="latar">
    ...
    <h1 style="margin-top:20;text-align:center;">PERBANDINGAN HARGA TELUR</h1>
