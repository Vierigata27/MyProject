...
if (isset($_POST["submit"])) {
    $produk = tampil("SELECT * FROM susu ORDER BY harga_barang DESC");
} else {
    $produk = tampil("SELECT * FROM susu"); // Default sorting
}
...
<link rel="stylesheet" href="tampil.css">
    ...
    <title>PERBANDINGAN HARGA SUSU</title>
    <style>
.tombol {
  display: flex;
...
<div class="latar">
    ...
    <h1 style="margin-top:20;text-align:center;">PERBANDINGAN HARGA SUSU</h1>
