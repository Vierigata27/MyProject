<?php
require 'koneksi.php';
$produk = tampil("SELECT * FROM garam");
...
<body>
    ...
    <a href="tambah5.php">Tambah produk garam</a>
    ...
    <tr>
        <td><?= $row["id_barang"]?></td>
        <td>
            <a href="ubah5.php?kode=<?= $row["id_barang"]; ?>">ubah</a> |
            <a href="hapus5.php?kode=<?= $row["id_barang"]; ?>"> hapus </a>
        </td>
