<?php
require 'koneksi.php';
$produk = tampil("SELECT * FROM minyak");
...
<body>
    ...
    <a href="tambah3.php">Tambah produk Minyak</a>
    ...
    <tr>
        <td><?= $row["id_barang"]?></td>
        <td>
            <a href="ubah3.php?kode=<?= $row["id_barang"]; ?>">ubah</a> |
            <a href="hapus3.php?kode=<?= $row["id_barang"]; ?>"> hapus </a>
        </td>
