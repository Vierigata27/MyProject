...
if (isset($_POST["submit"])) {
    $produk = tampil("SELECT * FROM minyak ORDER BY harga_barang DESC");
} else {
    $produk = tampil("SELECT * FROM minyak"); // Default sorting
}
?>
...
<head>
    ...
    <title>PERBANDINGAN HARGA MINYAK</title>
    <style>
.tombol {
  display: flex;
...
<body>
  <div class="latar">
    ...
    <h1 style="margin-top:20;text-align:center;">PERBANDINGAN HARGA MINYAK</h1>
