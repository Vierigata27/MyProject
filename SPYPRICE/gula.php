<?php
require 'koneksi.php';
$produk = tampil("SELECT * FROM gula");
...
<body>
    ...
    <a href="tambah.php">Tambah produk Gula</a>
    ...
    <tr>
        <td><?= $row["id_barang"]?></td>
        <td>
            <a href="ubah.php?kode=<?= $row["id_barang"]; ?>">ubah</a> |
            <a href="hapus.php?kode=<?= $row["id_barang"]; ?>"> hapus </a>
        </td>
