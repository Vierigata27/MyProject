<?php
require 'koneksi.php';
$produk = tampil("SELECT * FROM telur");
...
<body>
    ...
    <a href="tambah4.php">Tambah produk telur</a>
    ...
    <tr>
        <td><?= $row["id_barang"]?></td>
        <td>
            <a href="ubah4.php?kode=<?= $row["id_barang"]; ?>">ubah</a> |
            <a href="hapus4.php?kode=<?= $row["id_barang"]; ?>"> hapus </a>
        </td>
