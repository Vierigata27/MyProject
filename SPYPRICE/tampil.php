...
if (isset($_POST["submit"])) {
    $produk = tampil("SELECT * FROM gula ORDER BY harga_barang DESC");
} else {
    $produk = tampil("SELECT * FROM gula"); // Default sorting
}
...
<head>
    ...
    <title>PERBANDINGAN HARGA GULA</title>
<style>
...
<body>
    ...
    <div>
    <h1 style="margin-top:20;text-align:center;">PERBANDINGAN HARGA GULA</h1>
