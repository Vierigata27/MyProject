...
if (isset($_POST["submit"])) {
    $produk = tampil("SELECT * FROM garam ORDER BY harga_barang DESC");
} else {
    $produk = tampil("SELECT * FROM garam"); // Default sorting
}
?>
...
<head>
    ...
    <title>PERBANDINGAN HARGA GARAM</title>
    <style>
.tombol {
  display: flex;
...
<body>
  <div class="latar">
    ...
    <h1 style="margin-top:20;text-align:center;">PERBANDINGAN HARGA GARAM</h1>
