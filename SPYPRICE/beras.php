<?php
require 'koneksi.php';
$produk = tampil("SELECT * FROM beras");
...
<body>
    ...
    <a href="tambah1.php">Tambah produk Beras</a>
    ...
    <tr>
        <td><?= $row["id_barang"]?></td>
        <td>
            <a href="ubah1.php?kode=<?= $row["id_barang"]; ?>">ubah</a> |
            <a href="hapus1.php?kode=<?= $row["id_barang"]; ?>"> hapus </a>
        </td>
