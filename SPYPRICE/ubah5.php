...
$barang = mysqli_query($koneksi, "SELECT * FROM garam WHERE id_barang = $id_barang")->fetch_assoc();

if (isset($_POST["submit"])) {
    if (ubah5($_POST) > 0) {
        echo "<script>
            alert('Data berhasil diupdate!');
            document.location.href = 'garam.php';
        </script>";
    } else {
        echo "<script>
